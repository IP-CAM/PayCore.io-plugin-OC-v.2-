...
class ControllerExtensionPaymentPaycore extends Controller {
    ...
    public function index() {
        ...
        $data = $this->_setData(array(
            ...
            'action'                    => $this->makeUrl('extension/payment/paycore'),
            'cancel'                    => $this->makeUrl('extension/extension', 'type=payment'),
            'clear_log'                 => $this->makeUrl('extension/payment/paycore/clearLog'),
        ...
        $data['breadcrumbs'][] = array(
           'href'      => $this->makeUrl('extension/payment/paycore'),
        ...
        $this->response->setOutput($this->load->view('extension/payment/paycore.tpl', $data));
    }
    ...
    protected function validatePermission() {
        return $this->user->hasPermission('modify', 'extension/payment/paycore');
    }
